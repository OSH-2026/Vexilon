...
- [Vexilon](#vexilon)
  ...
  - [开发板选择与上板策略](#开发板选择与上板策略)
    - [开发板横向对比（WiFi-only 主线）](#开发板横向对比wifi-only-主线)
    - [主推荐方案：Hi3861V100 单开发板](#主推荐方案hi3861v100-单开发板)
...
### 主推荐方案：Hi3861V100 单开发板

当前阶段采用 Hi3861V100 单板即可完成核心验收项：
...
4. 先完成 WiFi-only + UART 闭环，再决定是否扩展多外设展示。
...
4. WiFi-only 输入：PC/手机发送 `STATUS/FEED/PLAY/SLEEP`，开发板返回状态。
