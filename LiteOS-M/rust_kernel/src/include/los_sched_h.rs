...
pub type SchedScan = ::std::option::Option<unsafe extern "C" fn() -> BOOL>;
unsafe extern "C" {
    pub fn OsSchedResetSchedResponseTime(responseTime: UINT64);
}
unsafe extern "C" {
    pub fn OsSchedSetIdleTaskSchedParam(idleTask: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedSwtmrScanRegister(func: SchedScan) -> UINT32;
}
unsafe extern "C" {
    pub fn OsSchedUpdateExpireTime();
}
unsafe extern "C" {
    pub fn OsSchedGetNextExpireTime(startTime: UINT64) -> UINT64;
}
unsafe extern "C" {
    pub fn OsSchedTaskDeQueue(taskCB: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedTaskEnQueue(taskCB: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedTaskWait(list: *mut LOS_DL_LIST, timeout: UINT32);
}
unsafe extern "C" {
    pub fn OsSchedTaskWake(resumedTask: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedModifyTaskSchedParam(taskCB: *mut LosTaskCB, priority: UINT16) -> BOOL;
}
unsafe extern "C" {
    pub fn OsSchedDelay(runTask: *mut LosTaskCB, tick: UINT32);
}
unsafe extern "C" {
    pub fn OsSchedYield();
}
unsafe extern "C" {
    pub fn OsSchedTaskExit(taskCB: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedSuspend(taskCB: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn OsSchedResume(taskCB: *mut LosTaskCB) -> BOOL;
}
unsafe extern "C" {
    pub fn OsSchedTick();
}
unsafe extern "C" {
    pub fn OsSchedInit() -> UINT32;
}
unsafe extern "C" {
    pub fn OsSchedStart();
}
unsafe extern "C" {
    pub fn OsSchedTaskSwitch() -> BOOL;
}
unsafe extern "C" {
    pub fn OsGetTopTask() -> *mut LosTaskCB;
}
unsafe extern "C" {
    pub fn OsSchedTimeConvertFreq(oldFreq: UINT32);
}
unsafe extern "C" {
    #[doc = " @ingroup los_sched\n @brief Get the time, in nanoseconds, remaining before the next tick interrupt response.\n\n @par Description:\n This API is used to get the time, in nanoseconds, remaining before the next tick interrupt response.\n\n @attention None.\n\n @param  None.\n\n @retval #time, in nanoseconds.\n @par Dependency:\n <ul><li>los_sched.h: the header file that contains the API declaration.</li></ul>\n @see"]
    pub fn LOS_SchedTickTimeoutNsGet() -> UINT64;
}
unsafe extern "C" {
    #[doc = " @ingroup los_sched\n @brief The system-provided tick interrupt handler.\n\n @par Description:\n This API is used to wake up a task that is blocked by time.\n\n @attention None.\n\n @param  None.\n\n @retval None.\n @par Dependency:\n <ul><li>los_sched.h: the header file that contains the API declaration.</li></ul>\n @see"]
    pub fn LOS_SchedTickHandler();
}
unsafe extern "C" {
