...
pub const LOS_CPUP_PRECISION: u32 = 1000;
pub const LOS_CPUP_PRECISION_MULT: u32 = 10;
pub const OS_CPUP_HISTORY_RECORD_NUM: u32 = 10;
...
pub struct OsCpupCB {
    ...
    #[doc = "< Task status"]
    pub status: UINT16,
    #[doc = "< Total running time"]
    pub allTime: UINT64,
    #[doc = "< Time before a task is invoked"]
    pub startTime: UINT64,
    #[doc = "< Historical running time"]
    pub historyTime: [UINT64; 10usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of OsCpupCB"][::std::mem::size_of::<OsCpupCB>() - 104usize];
    ["Alignment of OsCpupCB"][::std::mem::align_of::<OsCpupCB>() - 8usize];
    ["Offset of field: OsCpupCB::cpupID"][::std::mem::offset_of!(OsCpupCB, cpupID) - 0usize];
    ["Offset of field: OsCpupCB::status"][::std::mem::offset_of!(OsCpupCB, status) - 4usize];
    ["Offset of field: OsCpupCB::allTime"][::std::mem::offset_of!(OsCpupCB, allTime) - 8usize];
    ["Offset of field: OsCpupCB::startTime"][::std::mem::offset_of!(OsCpupCB, startTime) - 16usize];
    ["Offset of field: OsCpupCB::historyTime"]
        [::std::mem::offset_of!(OsCpupCB, historyTime) - 24usize];
};
unsafe extern "C" {
    pub static mut g_cpup: *mut OsCpupCB;
}
unsafe extern "C" {
    ...
    pub fn OsCpupInit() -> UINT32;
}
unsafe extern "C" {
    pub fn OsCpupDaemonInit() -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn OsTskCycleEndStart();
}
#[doc = " @ingroup los_cpup\n Count the CPU usage structures of all tasks."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct tagCpupInfo {
    #[doc = "< save the cur task status"]
    pub usStatus: UINT16,
    #[doc = "< Usage. The value range is [0,1000]."]
    pub uwUsage: UINT32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tagCpupInfo"][::std::mem::size_of::<tagCpupInfo>() - 8usize];
    ["Alignment of tagCpupInfo"][::std::mem::align_of::<tagCpupInfo>() - 4usize];
    ["Offset of field: tagCpupInfo::usStatus"]
        [::std::mem::offset_of!(tagCpupInfo, usStatus) - 0usize];
    ["Offset of field: tagCpupInfo::uwUsage"]
        [::std::mem::offset_of!(tagCpupInfo, uwUsage) - 4usize];
};
#[doc = " @ingroup los_cpup\n Count the CPU usage structures of all tasks."]
pub type CPUP_INFO_S = tagCpupInfo;
pub const CPUP_TYPE_E_SYS_CPU_USAGE: CPUP_TYPE_E = 0;
pub const CPUP_TYPE_E_TASK_CPU_USAGE: CPUP_TYPE_E = 1;
#[doc = " @ingroup los_monitor\n Type of the CPU usage query."]
pub type CPUP_TYPE_E = ::std::os::raw::c_uint;
pub const CPUP_MODE_E_CPUP_IN_10S: CPUP_MODE_E = 0;
pub const CPUP_MODE_E_CPUP_IN_1S: CPUP_MODE_E = 1;
pub const CPUP_MODE_E_CPUP_LESS_THAN_1S: CPUP_MODE_E = 2;
#[doc = " @ingroup los_monitor\n Mode of the CPU usage query."]
pub type CPUP_MODE_E = ::std::os::raw::c_uint;
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn LOS_HistorySysCpuUsage(mode: UINT16) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_TaskCpuUsage(taskID: UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_HistoryTaskCpuUsage(taskID: UINT32, mode: UINT16) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_AllTaskCpuUsage(cpupInfo: *mut CPUP_INFO_S, mode: UINT16) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_CpupUsageMonitor(type_: CPUP_TYPE_E, mode: CPUP_MODE_E, taskID: UINT32) -> UINT32;
}
