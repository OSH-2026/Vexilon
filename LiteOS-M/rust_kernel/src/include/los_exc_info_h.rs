...
pub const OS_WAIT_TASK_ARRAY_LEN: u32 = 1;
pub const OS_WAIT_TASK_ARRAY_ELEMENT_MASK: u32 = 31;
pub const OS_READWRITE_LEN: u32 = 2;
pub const OS_QUEUE_UNUSED: u32 = 0;
pub const OS_QUEUE_INUSED: u32 = 1;
pub const OS_QUEUE_WAIT_FOR_POOL: u32 = 1;
pub const OS_QUEUE_NORMAL: u32 = 0;
pub const OS_ALL_IPC_QUEUE_LIMIT: u32 = 6;
...
#[doc = " @ingroup los_queue\n Structure of the block for queue information query"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct tagQueueInfo {
    #[doc = "< Queue ID"]
    pub queueID: UINT32,
    #[doc = "< Queue length"]
    pub queueLen: UINT16,
    #[doc = "< Node size"]
    pub queueSize: UINT16,
    #[doc = "< Node head"]
    pub queueHead: UINT16,
    #[doc = "< Node tail"]
    pub queueTail: UINT16,
    #[doc = "< Count of writable resources"]
    pub writableCnt: UINT16,
    #[doc = "< Count of readable resources"]
    pub readableCnt: UINT16,
    #[doc = "< Resource reading task"]
    pub waitReadTask: [UINT32; 1usize],
    #[doc = "< Resource writing task"]
    pub waitWriteTask: [UINT32; 1usize],
    #[doc = "< Memory task"]
    pub waitMemTask: [UINT32; 1usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tagQueueInfo"][::std::mem::size_of::<tagQueueInfo>() - 28usize];
    ["Alignment of tagQueueInfo"][::std::mem::align_of::<tagQueueInfo>() - 4usize];
    ["Offset of field: tagQueueInfo::queueID"]
        [::std::mem::offset_of!(tagQueueInfo, queueID) - 0usize];
    ["Offset of field: tagQueueInfo::queueLen"]
        [::std::mem::offset_of!(tagQueueInfo, queueLen) - 4usize];
    ["Offset of field: tagQueueInfo::queueSize"]
        [::std::mem::offset_of!(tagQueueInfo, queueSize) - 6usize];
    ["Offset of field: tagQueueInfo::queueHead"]
        [::std::mem::offset_of!(tagQueueInfo, queueHead) - 8usize];
    ["Offset of field: tagQueueInfo::queueTail"]
        [::std::mem::offset_of!(tagQueueInfo, queueTail) - 10usize];
    ["Offset of field: tagQueueInfo::writableCnt"]
        [::std::mem::offset_of!(tagQueueInfo, writableCnt) - 12usize];
    ["Offset of field: tagQueueInfo::readableCnt"]
        [::std::mem::offset_of!(tagQueueInfo, readableCnt) - 14usize];
    ["Offset of field: tagQueueInfo::waitReadTask"]
        [::std::mem::offset_of!(tagQueueInfo, waitReadTask) - 16usize];
    ["Offset of field: tagQueueInfo::waitWriteTask"]
        [::std::mem::offset_of!(tagQueueInfo, waitWriteTask) - 20usize];
    ["Offset of field: tagQueueInfo::waitMemTask"]
        [::std::mem::offset_of!(tagQueueInfo, waitMemTask) - 24usize];
};
#[doc = " @ingroup los_queue\n Structure of the block for queue information query"]
pub type QUEUE_INFO_S = tagQueueInfo;
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn LOS_QueueReadCopy(
        queueID: UINT32,
        bufferAddr: *mut ::std::os::raw::c_void,
...
unsafe extern "C" {
    ...
    pub fn LOS_QueueDelete(queueID: UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_QueueInfoGet(queueID: UINT32, queueInfo: *mut QUEUE_INFO_S) -> UINT32;
}
pub const QueueReadWrite_OS_QUEUE_READ: QueueReadWrite = 0;
pub const QueueReadWrite_OS_QUEUE_WRITE: QueueReadWrite = 1;
pub type QueueReadWrite = ::std::os::raw::c_uint;
pub const QueueHeadTail_OS_QUEUE_HEAD: QueueHeadTail = 0;
pub const QueueHeadTail_OS_QUEUE_TAIL: QueueHeadTail = 1;
pub type QueueHeadTail = ::std::os::raw::c_uint;
pub const QueuePointOrNot_OS_QUEUE_NOT_POINT: QueuePointOrNot = 0;
pub const QueuePointOrNot_OS_QUEUE_POINT: QueuePointOrNot = 1;
pub type QueuePointOrNot = ::std::os::raw::c_uint;
#[doc = " @ingroup los_queue\n Queue information block structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct LosQueueCB {
    #[doc = "< Pointer to a queue handle"]
    pub queue: *mut UINT8,
    #[doc = "< Queue name"]
    pub queueName: *mut UINT8,
    #[doc = "< Queue state"]
    pub queueState: UINT16,
    #[doc = "< Queue length"]
    pub queueLen: UINT16,
    #[doc = "< Node size"]
    pub queueSize: UINT16,
    ...
    #[doc = "< Node tail"]
    pub queueTail: UINT16,
    #[doc = "< Count of readable or writable resources, 0:readable, 1:writable"]
    pub readWriteableCnt: [UINT16; 2usize],
    #[doc = "< Pointer to the linked list to be read or written,\n0:readlist, 1:writelist"]
    pub readWriteList: [LOS_DL_LIST; 2usize],
    #[doc = "< Pointer to the memory linked list"]
    pub memList: LOS_DL_LIST,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of LosQueueCB"][::std::mem::size_of::<LosQueueCB>() - 80usize];
    ["Alignment of LosQueueCB"][::std::mem::align_of::<LosQueueCB>() - 8usize];
    ["Offset of field: LosQueueCB::queue"][::std::mem::offset_of!(LosQueueCB, queue) - 0usize];
    ["Offset of field: LosQueueCB::queueName"]
        [::std::mem::offset_of!(LosQueueCB, queueName) - 8usize];
    ["Offset of field: LosQueueCB::queueState"]
        [::std::mem::offset_of!(LosQueueCB, queueState) - 16usize];
    ["Offset of field: LosQueueCB::queueLen"]
        [::std::mem::offset_of!(LosQueueCB, queueLen) - 18usize];
    ["Offset of field: LosQueueCB::queueSize"]
        [::std::mem::offset_of!(LosQueueCB, queueSize) - 20usize];
    ["Offset of field: LosQueueCB::queueID"][::std::mem::offset_of!(LosQueueCB, queueID) - 22usize];
    ["Offset of field: LosQueueCB::queueHead"]
        [::std::mem::offset_of!(LosQueueCB, queueHead) - 24usize];
    ["Offset of field: LosQueueCB::queueTail"]
        [::std::mem::offset_of!(LosQueueCB, queueTail) - 26usize];
    ["Offset of field: LosQueueCB::readWriteableCnt"]
        [::std::mem::offset_of!(LosQueueCB, readWriteableCnt) - 28usize];
    ["Offset of field: LosQueueCB::readWriteList"]
        [::std::mem::offset_of!(LosQueueCB, readWriteList) - 32usize];
    ["Offset of field: LosQueueCB::memList"][::std::mem::offset_of!(LosQueueCB, memList) - 64usize];
};
unsafe extern "C" {
    pub fn OsGetQueueHandle(queueID: UINT32) -> *mut LosQueueCB;
}
unsafe extern "C" {
    #[doc = "  @ingroup los_queue\n  Queue information control block"]
    pub static mut g_allQueue: *mut LosQueueCB;
}
unsafe extern "C" {
    ...
    pub fn OsQueueMailAlloc(
        queueID: UINT32,
        mailPool: *mut ::std::os::raw::c_void,
        timeOut: UINT32,
    ) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    ...
    pub fn OsQueueMailFree(
        queueID: UINT32,
        mailPool: *mut ::std::os::raw::c_void,
        mailMem: *mut ::std::os::raw::c_void,
    ) -> UINT32;
}
unsafe extern "C" {
    #[doc = " @ingroup los_queue\n @brief Initialization queue.\n\n @par Description:\n This API is used to initialization queue.\n @attention\n <ul>\n <li>None.</li>\n </ul>\n\n @param None.\n\n @retval   UINT32  Initialization result.\n @par Dependency:\n <ul><li>los_queue.h: the header file that contains the API declaration.</li></ul>\n @see None."]
    pub fn OsQueueInit() -> UINT32;
}
unsafe extern "C" {
