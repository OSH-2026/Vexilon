...
pub const PRINT_PER_ROW: u32 = 4;
pub const TRACE_NUM: u32 = 200;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct SchedTraceInfo {
    pub newTaskID: UINT32,
    pub newTaskName: [CHAR; 32usize],
    pub runTaskID: UINT32,
    pub runTaskName: [CHAR; 32usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of SchedTraceInfo"][::std::mem::size_of::<SchedTraceInfo>() - 72usize];
    ["Alignment of SchedTraceInfo"][::std::mem::align_of::<SchedTraceInfo>() - 4usize];
    ["Offset of field: SchedTraceInfo::newTaskID"]
        [::std::mem::offset_of!(SchedTraceInfo, newTaskID) - 0usize];
    ["Offset of field: SchedTraceInfo::newTaskName"]
        [::std::mem::offset_of!(SchedTraceInfo, newTaskName) - 4usize];
    ["Offset of field: SchedTraceInfo::runTaskID"]
        [::std::mem::offset_of!(SchedTraceInfo, runTaskID) - 36usize];
    ["Offset of field: SchedTraceInfo::runTaskName"]
        [::std::mem::offset_of!(SchedTraceInfo, runTaskName) - 40usize];
};
pub type SchedTraceRecordCB =
    ::std::option::Option<unsafe extern "C" fn(newTask: *mut LosTaskCB, runTask: *mut LosTaskCB)>;
pub type SchedTraceShowCB =
    ::std::option::Option<unsafe extern "C" fn(ringBuf: *mut SchedTraceInfo, count: UINT32)>;
unsafe extern "C" {
    pub fn OsShellCmdStackDump(argc: INT32, argv: *mut *const CHAR) -> UINT32;
}
unsafe extern "C" {
    pub fn OsShellCmdHwiDump(argc: INT32, argv: *mut *const CHAR) -> UINT32;
}
unsafe extern "C" {
    pub fn OsShellCmdSchedTrace(argc: INT32, argv: *mut *const CHAR) -> UINT32;
}
unsafe extern "C" {
    pub fn OsSchedTraceRecord(newTask: *mut LosTaskCB, runTask: *mut LosTaskCB);
}
unsafe extern "C" {
    pub fn LOS_TaskStackDump(taskID: UINT32);
}
unsafe extern "C" {
    pub fn LOS_SchedTraceHandleRegister(recordCB: SchedTraceRecordCB, showCB: SchedTraceShowCB);
}
unsafe extern "C" {
    pub fn LOS_SchedTraceStart();
}
unsafe extern "C" {
    pub fn LOS_SchedTraceStop();
}
