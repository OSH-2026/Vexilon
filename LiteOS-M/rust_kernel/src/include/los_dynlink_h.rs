...
pub const NT_FDO_DLOPEN_METADATA: u32 = 1081871370;
...
pub const LD_ELFMAG: &[u8; 5] = b"\x7FELF\0";
pub const LD_SELFMAG: u32 = 4;
pub const PHDR_NUM_MAX: u32 = 128;
pub const DYNAMIC_CNT: u32 = 32;
pub const HASH_MASK: u32 = 4026531840;
pub const WORD_SHIFT: u32 = 4;
pub const HASH_SHIFT: u32 = 24;
pub const BUCKET_IDX: u32 = 2;
pub const PATH_MAX: u32 = 256;
pub const FILE_LENGTH_MAX: u32 = 262144;
...
pub type LD_ELF_EHDR = Elf32_Ehdr;
pub type LD_ELF_PHDR = Elf32_Phdr;
pub type LD_ELF_SYM = Elf32_Sym;
pub type LD_ELF_DYN = Elf32_Dyn;
pub type LD_ELF_REL = Elf32_Rel;
pub type LD_ELF_RELA = Elf32_Rela;
pub type INIT_FINI_FUNC = ::std::option::Option<unsafe extern "C" fn()>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct RelocInfo {
    pub relTab: UINTPTR,
    pub relTabSize: UINT32,
    pub relEntSize: UINT32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of RelocInfo"][::std::mem::size_of::<RelocInfo>() - 12usize];
    ["Alignment of RelocInfo"][::std::mem::align_of::<RelocInfo>() - 4usize];
    ["Offset of field: RelocInfo::relTab"][::std::mem::offset_of!(RelocInfo, relTab) - 0usize];
    ["Offset of field: RelocInfo::relTabSize"]
        [::std::mem::offset_of!(RelocInfo, relTabSize) - 4usize];
    ["Offset of field: RelocInfo::relEntSize"]
        [::std::mem::offset_of!(RelocInfo, relEntSize) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct RelocInfoTab {
    pub rel: RelocInfo,
    pub rela: RelocInfo,
    pub jmpRel: RelocInfo,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of RelocInfoTab"][::std::mem::size_of::<RelocInfoTab>() - 36usize];
    ["Alignment of RelocInfoTab"][::std::mem::align_of::<RelocInfoTab>() - 4usize];
    ["Offset of field: RelocInfoTab::rel"][::std::mem::offset_of!(RelocInfoTab, rel) - 0usize];
    ["Offset of field: RelocInfoTab::rela"][::std::mem::offset_of!(RelocInfoTab, rela) - 12usize];
    ["Offset of field: RelocInfoTab::jmpRel"]
        [::std::mem::offset_of!(RelocInfoTab, jmpRel) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct InitFiniInfo {
    pub func: UINTPTR,
    pub array: UINTPTR,
    pub arraySz: UINT32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of InitFiniInfo"][::std::mem::size_of::<InitFiniInfo>() - 12usize];
    ["Alignment of InitFiniInfo"][::std::mem::align_of::<InitFiniInfo>() - 4usize];
    ["Offset of field: InitFiniInfo::func"][::std::mem::offset_of!(InitFiniInfo, func) - 0usize];
    ["Offset of field: InitFiniInfo::array"][::std::mem::offset_of!(InitFiniInfo, array) - 4usize];
    ["Offset of field: InitFiniInfo::arraySz"]
        [::std::mem::offset_of!(InitFiniInfo, arraySz) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct InitFiniTab {
    pub init: InitFiniInfo,
    pub fini: InitFiniInfo,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of InitFiniTab"][::std::mem::size_of::<InitFiniTab>() - 24usize];
    ["Alignment of InitFiniTab"][::std::mem::align_of::<InitFiniTab>() - 4usize];
    ["Offset of field: InitFiniTab::init"][::std::mem::offset_of!(InitFiniTab, init) - 0usize];
    ["Offset of field: InitFiniTab::fini"][::std::mem::offset_of!(InitFiniTab, fini) - 12usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct DynLinkInfo {
    pub elfEhdr: LD_ELF_EHDR,
    pub elfPhdr: *mut LD_ELF_PHDR,
    pub dynBase: UINTPTR,
    pub hashTab: *mut UINT32,
    pub symTab: *mut LD_ELF_SYM,
    pub symStrings: *mut CHAR,
    pub relInfoTab: RelocInfoTab,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
#[repr(C)]
#[derive(Debug)]
pub struct DynSharedObj {
    pub fileName: *mut CHAR,
    pub fd: INT32,
    pub dlInfo: *mut DynLinkInfo,
    pub loadBase: UINTPTR,
    pub initFiniTab: InitFiniTab,
    pub dsoNode: LOS_DL_LIST,
    pub ref_: UINT32,
    pub pool: *mut ::std::os::raw::c_void,
    pub buf: __IncompleteArrayField<CHAR>,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
unsafe extern "C" {
    pub fn LOS_SoUnload(handle: *mut ::std::os::raw::c_void) -> INT32;
}
unsafe extern "C" {
    pub fn LOS_DynlinkInit() -> INT32;
}
