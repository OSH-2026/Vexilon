...
pub const LOS_HOOK_TYPE_MEM_INIT: u32 = 1;   //Defined by RushToLight
pub const LOS_HOOK_TYPE_MEM_ALLOC: u32 = 2;  //Defined by RushToLight
#[repr(C)]
...
pub const OS_SEM_BINARY_MAX_COUNT: u32 = 1;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of LosMuxCB"][::std::mem::size_of::<LosMuxCB>() - 40usize];
    ["Alignment of LosMuxCB"][::std::mem::align_of::<LosMuxCB>() - 8usize];
    ...
    ["Offset of field: LosMuxCB::owner"][::std::mem::offset_of!(LosMuxCB, owner) - 24usize];
    ["Offset of field: LosMuxCB::priority"][::std::mem::offset_of!(LosMuxCB, priority) - 32usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn LOS_SemCreate(count: UINT16, semHandle: *mut UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_BinarySemCreate(count: UINT16, semHandle: *mut UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_SemDelete(semHandle: UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_SemPend(semHandle: UINT32, timeout: UINT32) -> UINT32;
}
unsafe extern "C" {
    ...
    pub fn LOS_SemPost(semHandle: UINT32) -> UINT32;
}
unsafe extern "C" {
    pub fn LOS_SemGetValue(semHandle: UINT32, currVal: *mut INT32) -> UINT32;
}
...
pub struct LosSemCB {
    #[doc = "< Semaphore state"]
    pub semStat: UINT16,
    #[doc = "< Number of available semaphores"]
    pub semCount: UINT16,
    #[doc = "< Max number of available semaphores"]
    pub maxSemCount: UINT16,
    #[doc = "< Semaphore control structure ID"]
    pub semID: UINT16,
    #[doc = "< Queue of tasks that are waiting on a semaphore"]
    pub semList: LOS_DL_LIST,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of LosSemCB"][::std::mem::size_of::<LosSemCB>() - 24usize];
    ["Alignment of LosSemCB"][::std::mem::align_of::<LosSemCB>() - 8usize];
    ["Offset of field: LosSemCB::semStat"][::std::mem::offset_of!(LosSemCB, semStat) - 0usize];
    ["Offset of field: LosSemCB::semCount"][::std::mem::offset_of!(LosSemCB, semCount) - 2usize];
    ["Offset of field: LosSemCB::maxSemCount"]
        [::std::mem::offset_of!(LosSemCB, maxSemCount) - 4usize];
    ["Offset of field: LosSemCB::semID"][::std::mem::offset_of!(LosSemCB, semID) - 6usize];
    ["Offset of field: LosSemCB::semList"][::std::mem::offset_of!(LosSemCB, semList) - 8usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn OsSemCreate(count: UINT16, maxCount: UINT16, semHandle: *mut UINT32) -> UINT32;
}
